<template>
  <div style="margin-bottom: 50px;">
    ...
    <form v-on:submit.prevent="submit">
      ...
      <div class="form-group">
        ...
        <p class="form-text text-muted">handler code will be run in <a href="https://www.npmjs.com/package/safe-eval">safe-eval</a>, injected variable can be used:
          <a href="https://github.com/postmanlabs/newman#newmanruncallbackerror-object--summary-object">summary</a>,
    ...
    <div style="margin-top: 2rem;">
      <h4>Debug Result (example <span class="mm-click" style="color: #0275d8" v-on:click="showExampleSummary = true">summary</span>)</h4>
      <p>
        {{debugResult}}
      </p>
    </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="json-view">
                <tree-view :data="summary" :options="{maxDepth: 3}"></tree-view>
              </div>
            </div>
          </div>
        </div>
